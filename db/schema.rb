...
ActiveRecord::Schema.define(version: 20170222015120) do
  ...
  create_table "list_items", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["feature_id"], name: "index_list_items_on_feature_id", using: :btree
    t.index ["user_id", "feature_id"], name: "index_list_items_on_user_id_and_feature_id", unique: true, using: :btree
